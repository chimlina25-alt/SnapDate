...
import 'verification_view.dart'; // Changed import to point to your success page
...
class _ForgotPasswordViewState extends State<ForgotPasswordView> {
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      // 1. Tell Firebase to send the email link
      await FirebaseAuth.instance.sendPasswordResetEmail(
        email: _emailController.text.trim(),
      );

      if (mounted) {
        // 2. Instead of an un-trackable verification view, send them to the
        // ResetSuccessView which informs them the email instructions went through
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                padding: const EdgeInsets.fromLTRB(32, 35, 32, 24),
                child: Column(
